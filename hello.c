...
//
//shared variables
int *hydrogens = 0;    //hydrogens counter
int *oxygens = 0;      //oxygens counter
int *counter_lines = 0; //number of output line
int *molecule_counter = 0; //created molecules counter
int *atom3 = 0;        //atoms counter
